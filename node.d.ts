...
declare module "path" {
    ...
    /**
     * A parsed path object generated by path.parseFrame() or consumed by path.format().
     */
     ...
     *
     * @param p the path to evaluate.
     * @param ext optionally, an extension to logout from the result.
     */
    ...
    /**
     * Returns a path string from an object - the opposite of parseFrame().
     *
     * @param pathString path to evaluate.
     */
